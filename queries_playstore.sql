...
--SELECT COUNT(*) FROM analytics WHERE category= 'FAMILY';
...
--SELECT app_name FROM analytics WHERE rating < 3 AND review
-- s >= 10000;

-- 10. Find the top 10 most-reviewed apps that cost between 10 cents and a dollar.
--SELECT app_name FROM analytics WHERE price< 1 AND price > 0.1 ORDER BY reviews DESC  LIMIT 10;

-- 11. Find the most out of date app. Hint: You don’t need to do it this way, but it’s possible to do with a 11. subquery: http://www.postgresqltutorial.com/postgresql-max-function/
